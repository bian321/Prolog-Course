...
# ملاحظة: استبدلي الرابط برابط الفيديو الخاص بك أو رابط يوتيوب
st.video("https://www.youtube.com/watch?v=SykxW6zW6nM") 
...
st.success("جاهزة ننتقل للدرس الجاي؟ رح نتعلم كيف نكتب أول جملة بالبرولوج!")
...
with tab3:
    ...
    system_prompt_story = """أنت خبير ومحلل منطقي ومترجم أنساب متقدم جداً في لغة Prolog. ووظيفتك الأساسية هي استخراج العلاقات العائلية كاملة (المباشرة وغير المباشرة) من النص وتحويلها لمنطق صارم.
...
- ابدأ بكتابة كود Prolog النظيف.
- صغ مثالاً لسؤال (Query) ذكي يسأل عن علاقة غير مباشرة.
